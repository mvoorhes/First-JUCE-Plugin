...
void FirstJUCEpluginAudioProcessor::prepareToPlay (double sampleRate, int samplesPerBlock)
{
    ...
    *rightChain.get<ChainPositions::Peak>().coefficients = *peakCoefficients;
    ...
    leftLowCut.setBypassed<Slope_36>(true);
    leftLowCut.setBypassed<Slope_48>(true);
    
    // Tried to optimize this further but couldn't. This is the best I can do (I think)
    for (int i = 0; i <= chainSettings.lowCutSlope; i++) {
        switch (i) {
            case Slope_12:
